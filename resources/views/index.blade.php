		            ...
		            <div class="MultiCarousel-inner">
		                ...
		                <div class="item">
		                    <div class="pad15">
								...
								<a href="#" class="addtocartBtn text-decoration-none" data-id="{{ $item->id }}" data-name="{{ $item->name }}" data-photo="{{ $item->photo }}" data-price="{{ $item->price }}" data-qty="1">Add to Cart</a>
